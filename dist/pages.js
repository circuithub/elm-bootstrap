...
Elm.ElmComponents = Elm.ElmComponents || {};
Elm.ElmComponents.make = function (_elm) {
   "use strict";
   _elm.ElmComponents = _elm.ElmComponents || {};
   if (_elm.ElmComponents.values)
   return _elm.ElmComponents.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   _P = _N.Ports.make(_elm),
   $moduleName = "ElmComponents",
   $Graphics$Element = Elm.Graphics.Element.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Window = Elm.Window.make(_elm);
   var view = A2($Html.body,
   _L.fromArray([]),
   _L.fromArray([A2($Html.a,
   _L.fromArray([$Html$Attributes.$class("sr-only sr-only-focusable")
                ,$Html$Attributes.href("#content")]),
   _L.fromArray([$Html.text("Skip to main content")]))]));
   ...
   $Signal.constant("Elm &middot; Elmstrap"));
   _elm.ElmComponents.values = {_op: _op
                               ,view: view
                               ,main: main
                               ,scene: scene};
   return _elm.ElmComponents.values;
...
Elm.PlainComponents = Elm.PlainComponents || {};
Elm.PlainComponents.make = function (_elm) {
   "use strict";
   _elm.PlainComponents = _elm.PlainComponents || {};
   if (_elm.PlainComponents.values)
   return _elm.PlainComponents.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   _P = _N.Ports.make(_elm),
   $moduleName = "PlainComponents",
   $Graphics$Element = Elm.Graphics.Element.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Window = Elm.Window.make(_elm);
   var view = function () {
      var bsDocsSection = $Html.div(_L.fromArray([$Html$Attributes.$class("bs-docs-section")]));
      var p_ = function (t) {
         return A2($Html.p,
         _L.fromArray([]),
      ...
      var a$ = F2(function (url,t) {
         return A2($Html.a,
         _L.fromArray([$Html$Attributes.href(url)]),
         _L.fromArray([$Html.text(t)]));
      });
      var h2$ = F2(function (i,t) {
         return A2($Html.h2,
         _L.fromArray([$Html$Attributes.id(i)]),
         _L.fromArray([$Html.text(t)]));
      });
      var h1_ = function (t) {
         return A2($Html.h1,
      ...
      var div$ = function (c) {
         return $Html.div(_L.fromArray([$Html$Attributes.$class(c)]));
      };
      var pageHeader = F2(function (i,
      t) {
         return A2($Html.h1,
         _L.fromArray([$Html$Attributes.id(i)
      ...
      var inputGroupAddon = $Html.span(_L.fromArray([$Html$Attributes.$class("input-group-addon")]));
      var inputGroup = $Html.div(_L.fromArray([$Html$Attributes.$class("input-group")]));
      var colLg6 = $Html.div(_L.fromArray([$Html$Attributes.$class("col-lg-6")]));
      var colMd9 = $Html.div(_L.fromArray([$Html$Attributes.$class("col-md-9")]));
      var colMd3 = $Html.div(_L.fromArray([$Html$Attributes.$class("col-md-3")]));
      var row = $Html.div(_L.fromArray([$Html$Attributes.$class("row")]));
      var iconBar = A2($Html.span,
      ...
      _L.fromArray([A2($Html.a,
                   ...
                   _L.fromArray([$Html.text("Skip to main content")]))
                   ,A2($Html.header,
                   _L.fromArray([$Html$Attributes.$class("navbar navbar-static-top bs-docs-nav")
                                ,$Html$Attributes.id("top")]),
                   _L.fromArray([container(_L.fromArray([A2($Html.div,
                                                        ...
                                                        ,A2($Html.nav,
                                                        _L.fromArray([$Html$Attributes.$class("collapse navbar-collapse bs-navbar-collapse")]),
                                                        _L.fromArray([A2($Html.ul,
                                                        _L.fromArray([$Html$Attributes.$class("nav navbar-nav")]),
                                                        _L.fromArray([li_(_L.fromArray([A2(a$,
                                                                     "../getting-started/",
                                                                     "Getting started")]))
                                                                     ,li_(_L.fromArray([A2(a$,
                                                                     "../css/",
                                                                     "CSS")]))
                                                                     ,A2($Html.li,
                                                                     ...
                                                                     "Customize")]))]))]))]))]))
                   ,A2($Html.div,
                   _L.fromArray([$Html$Attributes.$class("bs-docs-header")
                                ,$Html$Attributes.id("content")]),
                   _L.fromArray([container(_L.fromArray([h1_("Components")
                                                        ,p_("Over a dozen reusable components built to provide iconography, dropdowns, input groups, navigation, alerts, and much more.")]))]))
                   ,A2($Html.div,
                   _L.fromArray([$Html$Attributes.$class("container bs-docs-container")]),
                   _L.fromArray([row(_L.fromArray([colMd9(_L.fromArray([bsDocsSection(_L.fromArray([A2(pageHeader,
                                                                                                   "glyphicons",
                                                                                                   "Glyphicons")
                                                                                                   ,A2(h2$,
                                                                                                   "glyphicons-glyphs",
                                                                                                   ...
                                                                                                   "glyphicons-examples",
                                                                                                   "Examples")]))
                                                                       ,bsDocsSection(_L.fromArray([A2(pageHeader,
                                                                       "dropdowns",
                                                                       "Dropdowns")]))
                                                                       ,bsDocsSection(_L.fromArray([A2(pageHeader,
                                                                       "btn-groups",
                                                  ...
                                                  ,colMd3(_L.fromArray([]))]))]))
                   ,A2($Html.footer,
                   _L.fromArray([$Html$Attributes.$class("bs-docs-footer")]),
                   _L.fromArray([]))]));
   }();
   var scene = function (_v0) {
      return function () {
   ...
   $Signal.constant("Components &middot; Elmstrap"));
   _elm.PlainComponents.values = {_op: _op
                                 ,view: view
                                 ,main: main
                                 ,scene: scene};
   return _elm.PlainComponents.values;
